                ...
                if(!isset($_COOKIE["idDOador"])) {
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        <div class=\"form-row\">
                            ...
                            <input type=\"text\" class=\"form-control\" name=\"inputNome\" id=\"inputNome\" placeholder=\"Nome\" value=\"". $row["nome"]."\">
                            </div>
                            <div class=\"form-group col-md-6\">
                            <label for=\"inputTelefone\">Telefone</label>
                            <input type=\"text\" class=\"form-control\" name=\"inputTelefone\" id=\"inputTelefone\" placeholder=\"Telefone\" value=\"". $row["telefone"]."\">
                            </div>
                        </div>
                        <div class=\"form-group\">
                            <label for=\"inputEndereco\">Endereco</label>
                            <input type=\"text\" class=\"form-control\" name=\"inputEndereco\" id=\"inputEndereco\" placeholder=\"1234 Main St\" value=\"". $row["endereco"]."\">
                        </div>
                        <div class=\"form-row\">
                            <div class=\"form-group col-md-6\">
                            ...
                            <div class=\"form-group col-md-6\">
                                ...
                                <input type=\"text\" class=\"form-control\" name=\"inputUltimaDoacao\" id=\"inputUltimaDoacao\" placeholder=\"Data da ultima doação\" value=\"". $row["ultimaDoacao"]."\">
                            </div>
                        </div>
