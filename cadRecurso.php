    ...
    <div class="cadform">
        ...
        <form method="POST" action="./php/registroRecurso.php">
            <div class="form-row">
                ...
                <input type="text" class="form-control" name="inputItem" id="inputItem" placeholder="Nome do item">
                </div>
                <div class="form-group col-md-6">
                <label for="inputQuantidade">Quantidade</label>
                <input type="text" class="form-control" name="inputQuantidade" id="inputQuantidade" placeholder="Quantidade">
                </div>
            </div>
